...
def cerrar_base_datos_leyes(conexion):
    conexion.close()#cierra base de datos leyes.hernanzazzarini

def cerrar_base_datos_usuarios(conexion):
    conexion.close()#cierra base de datos usuarios.hernanzazzarini
...
#función de Python que recupera y muestra todas las filas de una tabla llamada usuarios en una base de datos.
...
#imprime una lista de los usuarios con sus detalles, incluyendo su ID, apellido, nombre, DNI y teléfono .hernanzazzarini
...
# Luego, utiliza el método fetchone para recuperar el primer resultado de la consulta.hernanzazzarini
