#Concatenando programación - ULTIMA VERSION- CORREGIDO EL 6 (FINAL)
import sqlite3
...
#=======================
#Desarrollado por Jorge Pegoraro (buscar leyes)
...
#Desarrollado por Jorge  Pegoraro (para cargar leyes)
