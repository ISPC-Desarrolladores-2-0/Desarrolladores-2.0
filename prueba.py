...
############### Pamela Grisel Ponce ################# Consultar información usando el número de la ley. Si el número de ley se encuentra en la base, nos muestra el detalle. En el caso de una ley que no esta en la base, muestra el mensaje que no se encuentra la ley. 
...
########## Pamela Grisel Ponce ################ Por medio de esta función se invoca a las conecciones a las bases de datos. Se hace la precarga de leyes y se ejecuta el menú principal.
def main():
